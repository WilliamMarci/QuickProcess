    ...
    def __init__(self, year, channel):
        ...
        if channel == '0L':
            self.corr = correctionlib.CorrectionSet.from_file(os.path.expandvars(
                f'$CMSSW_BASE/src/PhysicsTools/QuickProcess/data/scale_factors/trigger/trigger_SF_0L_{self.era}.json'))
        if channel == '1L':
            ...
            self.corr_el = correctionlib.CorrectionSet.from_file(os.path.expandvars(
                f'$CMSSW_BASE/src/PhysicsTools/QuickProcess/data/scale_factors/trigger/scale_factors_Ele_{self.era}.json'))
        elif channel == '2L':
            self.corr_ElEl = correctionlib.CorrectionSet.from_file(os.path.expandvars(
                f'$CMSSW_BASE/src/PhysicsTools/QuickProcess/data/scale_factors/trigger/scale_factors_ElEl_{self.era}.json'))
            self.corr_ElMu = correctionlib.CorrectionSet.from_file(os.path.expandvars(
                f'$CMSSW_BASE/src/PhysicsTools/QuickProcess/data/scale_factors/trigger/scale_factors_ElMu_{self.era}.json'))
            self.corr_MuMu = correctionlib.CorrectionSet.from_file(os.path.expandvars(
                f'$CMSSW_BASE/src/PhysicsTools/QuickProcess/data/scale_factors/trigger/scale_factors_MuMu_{self.era}.json'))
